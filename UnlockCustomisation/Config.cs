...
namespace UnlockCustomisation
{
	public class UCConfig : ConfigFile
	{
		...
		public string SingleUnlocksHelp => "Allows blueprints to be unlocked when a different blueprint is unlocked. The sample entries unlock the Creature Decoy with the Cyclops Decoy Tube Upgrade, and the Mobile Vehicle Bay (whose TechType is Constructor) unlocks when the Seamoth is unlocked.";
		public string CompoundTechsHelp => "Allows one blueprint to be unlocked when two or more other blueprints are unlocked. The sample entry unlocks the Prawn Suit (Exosuit) when all of the Propulsion, Torpedo, Drill and Grappling Arm modules are unlocked.";
