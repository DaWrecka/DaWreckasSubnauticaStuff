...
namespace DWEquipmentBonanza
{
	...
	public class DWConfig : ConfigFile
	{
		...
		[Slider("Snowfox Solar Module efficiency", 0.01f, 0.06f, DefaultValue = 0.05f, Id = "SnowfoxSolarEfficiency",
			Step = 0.005f, Format = "{0:F3}",
			Tooltip = "Maximum amount of energy regenerated by the Snowfox Solar Module per second"), OnChange(nameof(OnSliderChange))]
		public float SnowfoxSolarMultiplier = 0.05f; // Multiplier applied to the local light amount to get amount of power regained from solar charger
