...
namespace DWEquipmentBonanza
{
	...
	public class DWConfig : ConfigFile
	{
		...
		[Slider("Snowfox Structural Integrity Field capacity", 10f, 200f, DefaultValue = 100f, Id = "SnowfoxSIFStrength",
			Step = 0.05f, Format = "{0:F2}",
			Tooltip = "Amount of damage that can be fully-absorbed by the Structural Integrity Field (and derivatives) at full strength."), OnChange(nameof(OnSliderChange))]
		public float SnowfoxSIFStrength = 100f; // Multiplier applied to the local light amount to get amount of power regained from solar charger
#endif
