...
namespace DWEquipmentBonanza
{
	...
	internal class AcidGloves : Equipable
	{
		...
		public AcidGloves() : base("AcidGloves", "Brine Gloves", "Reinforced dive gloves with an acid-resistant layer")
		{
			OnFinishedPatching += () =>
			{
				...
				EquipmentPatches.AddSubstitutions(this.TechType, new HashSet<TechType>() { TechType.RadiationGloves, TechType.ReinforcedGloves });
	...
	internal abstract class AcidSuitBase<T> : Equipable
	{
		...
		public AcidSuitBase(string classId, string friendlyName, string description) : base(classId, friendlyName, description)
		{
			...
			{
				TechTypeUtils.AddModTechType(this.TechType);
				EquipmentPatches.AddSubstitutions(this.TechType, new HashSet<TechType>() { TechType.RadiationSuit, TechType.ReinforcedDiveSuit });
	...
	internal class NitrogenBrineSuit2 : AcidSuitBase<NitrogenBrineSuit2>
	{
		...
		public override string[] StepsToFabricatorTab => DWConstants.BaseSuitsPath;
		public override TechType RequiredForUnlock => Main.GetNitrogenTechtype("deathrunremade_spineeelscale");
		...
		protected override RecipeData GetBlueprintRecipe()
		{
			...
			TechType ttEelScale = Main.GetNitrogenTechtype("deathrunremade_spineeelscale");
		...
		public NitrogenBrineSuit2() : base("NitrogenBrineSuit2", title, description)
		{
			...
			{
				Main.AddDamageResist(this.TechType, DamageType.Acid, 0.6f);
				EquipmentPatches.AddSubstitution(this.TechType, TechType.RadiationSuit);
				EquipmentPatches.AddSubstitution(this.TechType, TechType.ReinforcedDiveSuit);
			};
		}
	}
	...
	internal class NitrogenBrineSuit3 : AcidSuitBase<NitrogenBrineSuit3>
	{
		...
		public override string[] StepsToFabricatorTab => DWConstants.BaseSuitsPath;
		public override TechType RequiredForUnlock => Main.GetNitrogenTechtype("deathrunremade_lavalizardscale");
		...
		protected override RecipeData GetBlueprintRecipe()
		{
			...
			TechType ttEelScale = Main.GetNitrogenTechtype("deathrunremade_spineeelscale");
			TechType ttLizardScale = Main.GetNitrogenTechtype("deathrunremade_lavalizardscale");
	...
	internal class Blueprint_BrineMk1toMk2 : Blueprint
	{
		...
		protected override RecipeData GetBlueprintRecipe()
		{
			TechType ttAnimalScale = Main.GetNitrogenTechtype("deathrunremade_spineeelscale");
	...
	internal class Blueprint_ReinforcedMk2toBrineMk2 : Blueprint
	{
		...
		protected override string templateClassId => string.Empty;
#endif
		public override string[] StepsToFabricatorTab => new string[] { "deathrunremade_specialsuits" };
		...
		protected override RecipeData GetBlueprintRecipe()
		{
			RecipeData recipe = new RecipeData()
			{
				...
				Ingredients = new List<Ingredient>(new Ingredient[]
				{
					new Ingredient(Main.GetNitrogenTechtype("deathrunremade_reinforcedsuit2"), 1),
					new Ingredient(TechType.HydrochloricAcid, 1),
					new Ingredient(TechType.FiberMesh, 1),
					new Ingredient(TechType.Aerogel, 1)
				}),
	...
	internal class Blueprint_ReinforcedMk3toBrineMk3 : Blueprint
	{
		...
		protected override RecipeData GetBlueprintRecipe()
		{
			RecipeData recipe = new RecipeData()
			{
				...
				Ingredients = new List<Ingredient>(new Ingredient[]
				{
					new Ingredient(Main.GetNitrogenTechtype("deathrunremade_reinforcedsuit3"), 1),
					new Ingredient(TechType.HydrochloricAcid, 1),
					new Ingredient(TechType.FiberMesh, 1),
					new Ingredient(TechType.Aerogel, 1)
				}),
